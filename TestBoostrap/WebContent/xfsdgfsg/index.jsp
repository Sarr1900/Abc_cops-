<%-- <%@page import="com.pack.entities.Article" %>--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/TP3/bootstrap-4.5/css/bootstrap-grid.min.css>
        <link rel="stylesheet" href="/TP3/bootstrap-4.5/css/bootstrap-reboot.min.css>       
        <link rel="stylesheet" href="/TP3/bootstrap-4.5/css/bootstrap.min.css">
        <link /bootstrap.min.css">
        <script src='https://kit.fontawesome.com/a076d05399.js'></script>
          
        <title>Projet_FLYMYWAY AIRLINES</title>
    </head>
    <body>
    <div class="container">
     ...
     <div class="row justify-content-center">
            ...
            <div class="card d-flex mx-auto my-5">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
                        ...
                        <form action="#" name="myform" onsubmit="" class="px-5 pb-5">
        ...
        <script src="/TP3/js/jquery-3.4.1.slim.min.js"></script>
        <script src="/TP3//js/jquery-3.5.1.js"></script> 
        <script src="/TP3//bootstrap-4.5/js/bootstrap.min.js"></script>
        <script src="/TP3//js/popper.min.js"></script>
    </body>
</html>
